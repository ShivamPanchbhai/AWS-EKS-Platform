...
############################################################
# EBS CSI DRIVER ROLE
# Used by the EBS CSI driver addon in EKS module to provision and attach
# EBS volumes for persistent storage (e.g. Prometheus metrics)
# Uses Pod Identity for credential injection -- no IRSA needed
############################################################
